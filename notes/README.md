...
* [Decision Register](decisions.md) — settled and parked decisions. `CLAUDE.md`
...
* `project-status-phase5.pdf` — a point-in-time status export. **Gitignored on
  purpose**, so it exists only on the owner's machine; a fresh clone will not have it.
...
`spark/2026-07-04-ml-handoff-context.md`.
