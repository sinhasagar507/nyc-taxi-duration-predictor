...
TABLE_ID = 'external_fhv_tripdata'
BUCKET_NAME = 'dtc-de-course-448715-terra-bucket'
SOURCE_FOLDER = 'raw/nyc_taxi_data/fhv_taxi_data/'
...
OPTIONS (
  format = 'PARQUET',
  uris = ['gs://{BUCKET_NAME}/{SOURCE_FOLDER}*.parquet']
);
"""
...
with models.DAG(
    dag_id='create_external_table_fhv_taxi',
